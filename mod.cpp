...
author = "johnb43";
tooltip = "Weapons Balance - Project Infinite";
...
logoOver = "\z\wb_pi\addons\main\ui\logo_weapons_balance.paa";
logoSmall = "\z\wb_pi\addons\main\ui\logo_weapons_balance.paa";
